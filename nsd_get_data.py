...
"""
@StanBgy: Modified this function to input labels and categories inside, so we can used costumized files
If not passed into the fucntion, then it works as originally planned 
"""
